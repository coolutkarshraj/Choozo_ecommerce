package com.io.choozo.adapter.SearchAdapter;
...
public class SearchProductRvAdapter extends RecyclerView.Adapter<SearchProductRvAdapter.ViewHolder> {

    Context context;
    List<SearchProductList> item;
    int productId;
    ...
    public SearchProductRvAdapter(Context context, List<SearchProductList> item) {
    ...
    @NonNull
    @Override
    public SearchProductRvAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SearchProductRvAdapter.ViewHolder viewHolder, int i) {

        SearchProductList model = item.get(i);
        ...
        viewHolder.data(item.get(i),i);

    }

    public void setFilter(List<SearchProductList> newlist){
        item=new ArrayList<>();
        item.addAll(newlist);
   ...
   /* ---------------------------------------------- Go to the Cart Activity ------------------------------------------------*/
        public void data(SearchProductList itemCatModel, int ii) {
            final SearchProductList model = itemCatModel;
...
*/    }
    ...
    private void deleteProductfromWishList(SearchProductRvAdapter.ViewHolder viewHolder) {
