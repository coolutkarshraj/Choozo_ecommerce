...
public class TodayDealsProductListDataModel {
    ...
    @Expose
    private TodayDealsImages images;
    ...
    public TodayDealsImages getImages() {
        return images;
    }

    public void setImages(TodayDealsImages images) {
        this.images = images;
    }
